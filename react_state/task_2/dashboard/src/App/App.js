      ...
      <AppContext.Provider value={{ user, logOut }} >
        <div className={css(styles.app)}>
          ...
          <BodySection title="News from the school">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ut nibh eget nunc
              elementum vestibulum id sit amet tortor. Ut nec dui lacinia, tincidunt erat ornare,
              pharetra metus. Quisque id sapien vehicula, rutrum leo non, ultrices justo. Sed vestibulum,
              metus quis dapibus porttitor, nisl quam ornare arcu, a vestibulum nisi elit eget elit.
            </p>
          </BodySection>
          <Footer />
        </div>
